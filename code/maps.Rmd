...
spec.pal = colorNumeric(c('darkblue','dodgerblue','purple','purple'),
  ...
  addProviderTiles('Stamen.TonerLite') %>% 
   addCircles(data=spec.locs, lat=~Latitude.Degrees._mean,lng=~Longitude.Degrees._mean,
              label=~Site_Name,color="red", opacity=1, fillOpacity=1, radius=75000) %>%
    addCircles(data=pm.locs, lat=~Latitude.Degrees., lng=~Longitude.Degrees., label=~Site_Name,color="blue",
